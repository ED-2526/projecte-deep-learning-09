...
class Config:
    ...
    run_name: str = "wordlevel-labelsmoothing-beam-refined"
    encoder_checkpoint: str = "best_encoder_labelsmoothing_beam_refined.pth"
    decoder_checkpoint: str = "best_decoder_labelsmoothing_beam_refined.pth"
    max_images: int = 8000
    test_size: float = 0.2
    random_state: int = 42
    batch_size: int = 32
